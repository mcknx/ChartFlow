...
BpmnAdapter.shapeConfigMap.set(BpmnElements.TIME, {
  width: TimeStepConfig.width,
  height: TimeStepConfig.height,
});
BpmnAdapter.shapeConfigMap.set(BpmnElements.UI, {
  width: UIStepConfig.width,
  height: UIStepConfig.height,
});
