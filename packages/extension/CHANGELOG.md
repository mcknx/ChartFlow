...
## [1.2.5](https://github.com/didi/ChartFlow/compare/@chartflow/extension@1.2.4...@chartflow/extension@1.2.5) (2023-03-28)

**Note:** Version bump only for package @chartflow/extension
...
* add disabled_delete attr in  node-selection ([6b103d5](https://github.com/didi/ChartFlow/commit/6b103d56add41d22e35391627588288cadced47b))
* add disableNodeSelection callback in node-selection ([de21347](https://github.com/didi/ChartFlow/commit/de21347a9dff06a079ab7fe7ca35dc89f2206538))
* bpmn example use new control ([eb11ffa](https://github.com/didi/ChartFlow/commit/eb11ffa464e563946b58f7e0f18e2bc58383d9c0))
* context menu edge icon position ([f06ead4](https://github.com/didi/ChartFlow/commit/f06ead4e687498550012e654765430d1fa1f48a2))
* dnd-panel render ([26799eb](https://github.com/didi/ChartFlow/commit/26799ebe5ff1f396cb01c14b71ae8482ba4e2f50))
* edge setProperties in vue ([ecdaf34](https://github.com/didi/ChartFlow/commit/ecdaf34ad170e410ad979af8413e87bf86e8345b))
* export images compatible with Firefox([#269](https://github.com/didi/ChartFlow/issues/269)) ([d87065e](https://github.com/didi/ChartFlow/commit/d87065e404a6569fb16ee5c0d4c01bb67c2e117d))
* **extension-selection:** 修复开启selection后,右键仍会出现上下文菜单的问题 ([d15330c](https://github.com/didi/ChartFlow/commit/d15330cdbfc3f2018bf58058014a12ec6147e154))
* **extension:** minimap remove console ([f788d87](https://github.com/didi/ChartFlow/commit/f788d873a73be89bb15c2d0a5b0a70848580c7ad))
* **extension:** minimap remove console ([521f76c](https://github.com/didi/ChartFlow/commit/521f76c4d3db9b44421748daefb706f927a642d6))
* extensition-GroupShrink console->throw error ([c7cf0ef](https://github.com/didi/ChartFlow/commit/c7cf0effc1ba5ac171dfe345400ffe307386f0da))
* fix addNodeSelection methods in node-selection plugin ([f75afd4](https://github.com/didi/ChartFlow/commit/f75afd4678de91c11d97aa1c628a0b8417f01ed9))
* graphDownload ([2e94d30](https://github.com/didi/ChartFlow/commit/2e94d300b15784e6b29fde731c1eb87cacb82869))
* group undo cannot fold ([5860d7e](https://github.com/didi/ChartFlow/commit/5860d7ef4770f655fab1bb5ee6114dc63757b725))
* issues890 ([0aa4312](https://github.com/didi/ChartFlow/commit/0aa431230879735a63cb9701364b4ab27bde5610))
* lf.select -> lf.selectElementById ([f4eea2c](https://github.com/didi/ChartFlow/commit/f4eea2c23ec6ac44acbd404b35d94b74fbb69d00))
* mini map ([822adf9](https://github.com/didi/ChartFlow/commit/822adf9bddc53f9c82cd26790e8f83b9eb67f093))
* mini map viewport ([38c2408](https://github.com/didi/ChartFlow/commit/38c2408e0f8a76dd0b49b9271dd259fd8b6fa684))
* minimap become invisible when repeat init ([ad488fd](https://github.com/didi/ChartFlow/commit/ad488fde9041834e9e809eb38904c013751d9cc8))
* move lodash-es to dependencies ([b9c5206](https://github.com/didi/ChartFlow/commit/b9c5206a6cdc0d36aecdbc89889238f3f1973de0))
* node resize can`t set shape attributes ([9811e93](https://github.com/didi/ChartFlow/commit/9811e931adcab3e9c4ec5836e40d5ca766eb04e4))
* node resize set default style ([b9def97](https://github.com/didi/ChartFlow/commit/b9def9763f1fa0464c42adeffebf37fe20543151))
* nodeResize getResizeShape bugfix ([e617013](https://github.com/didi/ChartFlow/commit/e617013f979cd67dbe438dad141f0eef25690aa2))
* nodeResize outline bugfix ([8e76f5f](https://github.com/didi/ChartFlow/commit/8e76f5f8e79a18189f48339b85904b06d29cfda2))
* not create new edge while edge source and target both in group ([9ec3197](https://github.com/didi/ChartFlow/commit/9ec31975a81f0fc75f13fd54b6624dbd953b04c2))
* pattern callback ([1d29050](https://github.com/didi/ChartFlow/commit/1d290501712f74b13a1e4f5d3ae2d85109aa55dd))
* remove node selection ([64c5757](https://github.com/didi/ChartFlow/commit/64c5757817034c07c5e62d4345e6c33089b65788))
* rewrite control extension ([2e70363](https://github.com/didi/ChartFlow/commit/2e70363b7f1ac9fb3e0924f4cc439d412c6e492e))
* trigger extension render in difference env ([9be1f58](https://github.com/didi/ChartFlow/commit/9be1f58a3768fd48117e1143939c8a92f61191dc))
* type error ShapeItem ([9551c6d](https://github.com/didi/ChartFlow/commit/9551c6d4cd973e3f8f1dab71cb908b755deb401c))
* typo ([facccdf](https://github.com/didi/ChartFlow/commit/facccdf3b98d44650c75e34a66ed33f5e0d8f75e))
* typos ([ee9f3cd](https://github.com/didi/ChartFlow/commit/ee9f3cd40a819b13887938bf5e6018f77e575917))
* update logicflow site url ([8774efe](https://github.com/didi/ChartFlow/commit/8774efe5eb8411819e1a44f8c4698111f6fb6ea5))
* update turbo adapter ([205e6c8](https://github.com/didi/ChartFlow/commit/205e6c8e7cb8809ad1f04ec6b8c92b5d25416257))
* use autoToFront property take node to front ([3a8a7cc](https://github.com/didi/ChartFlow/commit/3a8a7cc6a981f53837f8774aa3130b7e6d5593b9))
* use blank:drop instead of graph:transform ([c7fc211](https://github.com/didi/ChartFlow/commit/c7fc211438715528651ef4923849a793c325a2c8))
* use model instead of getAttribute ([0e51cb0](https://github.com/didi/ChartFlow/commit/0e51cb0681c458bf68a69b8459ce0a4b91951ea4))
* version typo ([edc73ed](https://github.com/didi/ChartFlow/commit/edc73ede58859412fa1183fb3237013e4c56e9ad))
* virtual models cannot be included in group children.([#1022](https://github.com/didi/ChartFlow/issues/1022)) ([76d559d](https://github.com/didi/ChartFlow/commit/76d559d64f2033e541d8a1d631e240f8f9644ad9))
* 修复了`group`插件在多个`group`节点一起被折叠报错的问题。 ([396736e](https://github.com/didi/ChartFlow/commit/396736e07c320985f7c779b272085ba1f66f1083))
* 修复分组嵌套分组时子分组内部节点无法跟随移动的问题 ([c7edb01](https://github.com/didi/ChartFlow/commit/c7edb013907b474a65ed495817f983a3f1aafcae))
* 修复新增分组子节点未被记录的问题 ([24d9fc9](https://github.com/didi/ChartFlow/commit/24d9fc9d056f34141520da4a3f9482fe031ec325))


### Features

* add attribute visible to element ([4676427](https://github.com/didi/ChartFlow/commit/46764279f6667354b1d67186e0f131f764c3eb79))
* add context menu plugin ([8c5d7a8](https://github.com/didi/ChartFlow/commit/8c5d7a84309ba8d07fbbb99dcebcae81b521bd06))
* add curved edge ([b64928a](https://github.com/didi/ChartFlow/commit/b64928a486385aaa13f9dc07a28e790c982f5ada))
* add event to dnd-penal ([9707cfb](https://github.com/didi/ChartFlow/commit/9707cfb927f13b0e6dd022230c5466f145d48cf8))
* add extension-GroupShrink ([99e5414](https://github.com/didi/ChartFlow/commit/99e5414be5ac0168128320f255eb0882251c7a9c))
* add graph:rendered event ([a3838c3](https://github.com/didi/ChartFlow/commit/a3838c385328bc9e3a41e39c555736d5f59de573))
* add group hook ([a955e7c](https://github.com/didi/ChartFlow/commit/a955e7ca151e0dd547a3995bbfed42e68f25183a))
* add highlight plugin ([8081f91](https://github.com/didi/ChartFlow/commit/8081f91c448d4ed204f517a555af59c13bbde55f))
* add lfJson2Xml and lfXml2Json ([928a0d4](https://github.com/didi/ChartFlow/commit/928a0d42fd7cba383fe4768d1eafd01b59b668c3))
* add mind map plugin ([11ae7e0](https://github.com/didi/ChartFlow/commit/11ae7e06f878cb6b8c82f2f73f74e8e4620fecb6))
* add node resize maxwidth and maxheight ([e98f575](https://github.com/didi/ChartFlow/commit/e98f575d19c5c7c9a74c7ad3302c1a8cb02bd5e3))
* add useGlobalRules and customCssRules property ([88dadb8](https://github.com/didi/ChartFlow/commit/88dadb8e2c96d9f7ee4d4c286a6aa42c8941baaf))
* babel use loose mode ([7fed1fb](https://github.com/didi/ChartFlow/commit/7fed1fb9557e3ac7f6f7fc11ad3afcc1d3d7bad8))
* change MiniMap.show -> lf.extension.miniMap.show ([39e1a2f](https://github.com/didi/ChartFlow/commit/39e1a2fb254e480418275641880f454e5101e0c3))
* check width and height type ([141c667](https://github.com/didi/ChartFlow/commit/141c6678503870a9d7503864353ad6cc7493fd24))
* context-menu use className ([e58eaea](https://github.com/didi/ChartFlow/commit/e58eaea67aaf7c8f420aed849a4f77b753a1bc6c))
* **core&extension:** add pluginOptions attribute on lf instance ([47cd816](https://github.com/didi/ChartFlow/commit/47cd81647532a724456b191d0050f87e833cb968))
* custom edge ([81cd3be](https://github.com/didi/ChartFlow/commit/81cd3be6a9940553d2eec75b77a3472fdf75eb88))
* export context menu ([f0ff960](https://github.com/didi/ChartFlow/commit/f0ff960a2518cfe0e3f9d2a5abb843b87957def6))
* **extension:** htmlNode resize ([24209af](https://github.com/didi/ChartFlow/commit/24209afc16f8dd7acf824fd5231ee3e8266d45d7))
* **extension:** minimap enhance, fixes [#802](https://github.com/didi/ChartFlow/issues/802) ([15c6ca3](https://github.com/didi/ChartFlow/commit/15c6ca3d53026b6a18ffd41d0ff3167add96b7fd))
* **extension:** minimap pirvate modifier ([238fc5f](https://github.com/didi/ChartFlow/commit/238fc5f42fd5e20fb9cc57f10e45380e574c0f64))
* group add isAllowAppendIn to support pick node append in group ([e54f798](https://github.com/didi/ChartFlow/commit/e54f79845996e763098cb5749100c76063160023))
* group listen node:dnd-drag event ([3934d9c](https://github.com/didi/ChartFlow/commit/3934d9cb40dbe38aafccf4f94b0c880204fd1c1d))
* group support fold ([c1d8c10](https://github.com/didi/ChartFlow/commit/c1d8c109b25a3145c8c6858c4b6b5f0b6bf072ba))
* group support getAddableOutlineStyle ([a34f58c](https://github.com/didi/ChartFlow/commit/a34f58c11e9e73ab6dfd9536ac0980368281e62c))
* group support resize ([d9e2403](https://github.com/didi/ChartFlow/commit/d9e2403e00bce05c65d4d5b018ac3e2b9072cecd))
* hide mind map ([2aa1120](https://github.com/didi/ChartFlow/commit/2aa112002023b87188c9b132dbeb6c77e92e17bf))
* optimize drag node behavior ([f88042d](https://github.com/didi/ChartFlow/commit/f88042d5623a0983003bd70098b4e0c12ba60d3d))
* optimize move group children behavior ([d492f20](https://github.com/didi/ChartFlow/commit/d492f20a7205c81a709f7a151b9127a2709d81a4))
* optimize move node behavior ([d0e4e85](https://github.com/didi/ChartFlow/commit/d0e4e856cf58e92a98e309cdd698724bc1163295))
* release 1.0.0🎉🎉 ([670fed7](https://github.com/didi/ChartFlow/commit/670fed7fa3e0cb0ee39501251d177c693694ef59))
* remove console ([7771e65](https://github.com/didi/ChartFlow/commit/7771e6591dd25e51077930da4fe985d5e280d7e9))
* remove hideOutline ([be86fb1](https://github.com/didi/ChartFlow/commit/be86fb118bd8bb1bd67a999802544eb2d10df0da))
* remove node selection ([92d4b7a](https://github.com/didi/ChartFlow/commit/92d4b7a88727b8dd213487f09e1117afa5c48310))
* support disabled tool in core package ([1c7527f](https://github.com/didi/ChartFlow/commit/1c7527fc75929c444d9e5fb4b0b70b87086694c8))
* update turbo plugin ([ed512ca](https://github.com/didi/ChartFlow/commit/ed512ca21d21829cd7c114140b006964fc4090e4))
* use loose class properties ([921a09b](https://github.com/didi/ChartFlow/commit/921a09ba4b30a819eb315316e174a7bccfc9ffc8))


### Performance Improvements

* 优化layout trunk ([e261441](https://github.com/didi/ChartFlow/commit/e261441e6b3ab928939bda43101dd5e0348da9f8))
...
* 🐛 add the name field for the extension components ([24a2831](https://github.com/didi/ChartFlow/commit/24a28316e90070f48813c29c5d3a95f00b0eb4bc))
* 🐛 fix the result of setting menu in model ([74494a5](https://github.com/didi/ChartFlow/commit/74494a5060620b7b2193ae73c1b41697dc36fd9e))
* **all:** add rimraf ([c526ad8](https://github.com/didi/ChartFlow/commit/c526ad840b1e2620a3221d416f7a03e9c6d3583c))
* avoid reObserver view ([996fd65](https://github.com/didi/ChartFlow/commit/996fd6515d78b5331b08fd84025a148b45026cd9))
* bpmn exclusive gateway element text position ([baff6fe](https://github.com/didi/ChartFlow/commit/baff6fe2ffa1822791785470d55fbb49c048f9c6))
* build support ie ([4a90d5e](https://github.com/didi/ChartFlow/commit/4a90d5e0bb20f8dfd2f4ab88db5c691894521298))
* change the points type ([766c34b](https://github.com/didi/ChartFlow/commit/766c34b1276b3c0221bf0aeb6e7b7716e3b362dc))
* **core:** change the priority of events ([5373797](https://github.com/didi/ChartFlow/commit/53737978d109088a2aeac1b4492fcbd69d16ec35))
* **core:** fix checking repeatedly verification rules ([f0efbf4](https://github.com/didi/ChartFlow/commit/f0efbf481eb254bdaf29fd25b29ee1ee495d439b))
* **examples:** modified examples page title ([3a9ae5e](https://github.com/didi/ChartFlow/commit/3a9ae5ed100405378ed468574ca61445bef44035))
* extension destroy domContainer is undefined ([6f8fe13](https://github.com/didi/ChartFlow/commit/6f8fe1379aa5307ef2ba48bfb6d5072dfa132f33))
* **extension:** 🐛 fix bpmn demo download not work ([6cec577](https://github.com/didi/ChartFlow/commit/6cec57778ee833675176fe957a5a442ec21c1727))
* **extension:** 🐛fix undo error when custom text position ([fc6e7d7](https://github.com/didi/ChartFlow/commit/fc6e7d767889e8bbdd542a3c8006e352a86121c4))
* **extension:** fix adapter out data ([3941c4b](https://github.com/didi/ChartFlow/commit/3941c4ba2939ec1bcf452543e1da486fe2f64f9f))
* **extension:** init isDefalutStopMoveGraph of SelectionSelect ([88ec07b](https://github.com/didi/ChartFlow/commit/88ec07bb5d4d7ae6e242e68e46e4bc4278f5a17e))
* **extension:** mini-map default disable control & selection-select ([297cecf](https://github.com/didi/ChartFlow/commit/297cecf4637ca7a045619a10cd9298feacc631ea))
* **extension:** snapshot bugfix after zooming ([c23c0fa](https://github.com/didi/ChartFlow/commit/c23c0fa2d8ec0825f4319def7b98388cc3a09997))
* **extension:** snapshot forginObject in svg fix ([ef937a0](https://github.com/didi/ChartFlow/commit/ef937a08f2f4898b99376d06c25ee57c3f81fda2))
* format bpmn xml ([e3c9159](https://github.com/didi/ChartFlow/commit/e3c91599ced342ac64d92f54228bf8145cf52378))
* Gradient has outdated direction syntax ([48fdc1f](https://github.com/didi/ChartFlow/commit/48fdc1f3663d7f3a2c51563cbe7979332c9def18))
* loop path unique ([dc88286](https://github.com/didi/ChartFlow/commit/dc88286ea09cb00b2b64e5d4ab5a751d2fdae03e))
* menu error in vue ([4f123a9](https://github.com/didi/ChartFlow/commit/4f123a9e32ab17e3ecf30d5bbfaa773734e28437))
* mini map import error type ([99767e2](https://github.com/didi/ChartFlow/commit/99767e28f12e96b4181ae281b2ef4ac419719c75))
* minimap extension custom disabled plugin ([3768d14](https://github.com/didi/ChartFlow/commit/3768d149b6a72e4c251e287432b6070dcbfabce6))
* minimap support register node ([3a692e6](https://github.com/didi/ChartFlow/commit/3a692e6448d775ebdbd9c6f26fce79102c77fb3e))
* new selection select ([4fc34d4](https://github.com/didi/ChartFlow/commit/4fc34d41e1000629362c141a8c6a2eb033ecf17d))
* occasionally read isAllPass of undefined ([dac3d41](https://github.com/didi/ChartFlow/commit/dac3d4118aff2699497512ca799912deaa0b4930))
* polygon case error ([6c6e821](https://github.com/didi/ChartFlow/commit/6c6e821fb5fbc2d678235264b8caca42c97f44d2))
* remove unnecessary console ([102bd81](https://github.com/didi/ChartFlow/commit/102bd8179d5dd5f84e677ad39b209f49d2ee3a1b))
* set the start position of selection when mouse is down ([c7d3715](https://github.com/didi/ChartFlow/commit/c7d3715b956ed99e80bcb19a51d2e21432cd1037))
* show anchors when extend baseNode ([12bd0db](https://github.com/didi/ChartFlow/commit/12bd0db574b18b19aed8134b9e508f3c0a9ef6f4))
* support custom style by class for mini-map ([4c97625](https://github.com/didi/ChartFlow/commit/4c97625774f65ed3d59caefc5c691fabf0adc499))
* **textension:** rename function getShapeReise to getResizeShape ([88d6d53](https://github.com/didi/ChartFlow/commit/88d6d531dd6232a2abb952468fae0086813bce78))
* types ([a49bf16](https://github.com/didi/ChartFlow/commit/a49bf16e8ee994f1bacc4015deb054a9eeb44895))
* types ([37491ca](https://github.com/didi/ChartFlow/commit/37491cab07d7712aa4b94326424af3ded5031f75))
* typo ([5326634](https://github.com/didi/ChartFlow/commit/5326634b74768b6d630e83279983a68d1265fa83))
* typo menu ([ad797e3](https://github.com/didi/ChartFlow/commit/ad797e3e6d4a3f8ebd36c044cf3b90865cd0c66d))
* unexpect text position ([7559183](https://github.com/didi/ChartFlow/commit/7559183b1d218317cfe83396dc065b803362a948))
* update registerElement API in extension ([df25d11](https://github.com/didi/ChartFlow/commit/df25d110eee7051ee9357b11f669d80a3de1e0ea))
* use Control. __tool ([c739586](https://github.com/didi/ChartFlow/commit/c739586dd261ead077b2c86fefb7c6cc726b6f33))
* use pluginName replace name ([2b2706a](https://github.com/didi/ChartFlow/commit/2b2706a4596eaee5fb6e88328a219ebc9366505c))
* 修复control组件某些情况下无法销毁的问题 ([47fc75d](https://github.com/didi/ChartFlow/commit/47fc75dd942cba1c5cd441110b4d4e2e07ffc7a3))


### Features

* add custom TextPosition ([352047d](https://github.com/didi/ChartFlow/commit/352047d942cc505f36272ba1a64bae33c13b5897))
* add get flow path extension ([6a15d11](https://github.com/didi/ChartFlow/commit/6a15d110b83f92b0c147cb6935735f5345090f7f))
* add getSelectElements function ([d6b5a81](https://github.com/didi/ChartFlow/commit/d6b5a81a76ba59cac319cb01a3187caf0fb216ea))
* add increase overlap mode ([06068e4](https://github.com/didi/ChartFlow/commit/06068e4caa11544b709697d101063838020dc4d1))
* add mini map extension ([10d4056](https://github.com/didi/ChartFlow/commit/10d405662c1cefaa8f1172e41f4419e5170807b8))
* add mini-map extension ([fa621da](https://github.com/didi/ChartFlow/commit/fa621daf2cc6a05cd5265bfe5245f5424f97ae7e))
* add the switch of SelectionSelect in Extension ([35baa89](https://github.com/didi/ChartFlow/commit/35baa89a9ded2be1ce1fe7392fc9e75121f8e0d7))
* add the UMD dist of BpmnAdapter and TurboAdapter in extension ([2edac3b](https://github.com/didi/ChartFlow/commit/2edac3b7b7fb6deb873f7268a5fdb9cc116ed8b3))
* auto layout tmp ([ac58232](https://github.com/didi/ChartFlow/commit/ac58232150d58bd655b9e2180df9b545fbf46c0c))
* avoid add id in dom ([37cccb6](https://github.com/didi/ChartFlow/commit/37cccb6fc75451b25254c1ccda4c581f2bb5ce51)), closes [#309](https://github.com/didi/ChartFlow/issues/309)
* **core:** add disable extension config & extension need name ([8bd9355](https://github.com/didi/ChartFlow/commit/8bd93555b7f82eb30a4813c986e3e642c86578fb))
* **core:** copy paste and delete multiple selected elements ([4a5be86](https://github.com/didi/ChartFlow/commit/4a5be86c63c90b7c1c88e08e9d084e708307a80d))
* **core:** support use meta key select multiple element ([e137f9f](https://github.com/didi/ChartFlow/commit/e137f9fdbdb6bf3f85c3f7ac9323785e445844c8))
* dndpanel support properties, related [#181](https://github.com/didi/ChartFlow/issues/181) ([765416c](https://github.com/didi/ChartFlow/commit/765416c6051559f529cb5af1fe9d5d14304f3cf1))
* **docs:** add docs for NodeResize ([2a629bc](https://github.com/didi/ChartFlow/commit/2a629bc77641a88d63dbb3263f60b85a26bf227c))
* edge text support hover style ([ffc75d4](https://github.com/didi/ChartFlow/commit/ffc75d45e0ef42b9dbca1be489fa749186aa81b0))
* edgemodel support override getTextPosition ([5ede6f2](https://github.com/didi/ChartFlow/commit/5ede6f295c128c5f8c87af789105576f1f04ba57))
* extension add destroy property ([23e59e5](https://github.com/didi/ChartFlow/commit/23e59e5902976fced92ad67ddd72f74938113c96))
* **extension:** curved-edge ([1731b10](https://github.com/didi/ChartFlow/commit/1731b10e3e65ccf226b48d4fb572d90d2ad10dec))
* **extension:** drop node in polyline ([94480ac](https://github.com/didi/ChartFlow/commit/94480ac5b2b8d989a2310a3b4c25e08abe9d10b6))
* **extension:** endEvent node hide anchor ([6e2333f](https://github.com/didi/ChartFlow/commit/6e2333f2af8a214530a2c2ed3c1dc5597fcd68f1))
* **extension:** node resize ([35e3a0a](https://github.com/didi/ChartFlow/commit/35e3a0a4291fea87fe55238d1ca377664b2676ed))
* **extension:** node resize update ([5434840](https://github.com/didi/ChartFlow/commit/5434840692f741dfb71e385e07f1fe539f3355b1))
* **extension:** rect node resize ([399afb5](https://github.com/didi/ChartFlow/commit/399afb545b421345ca3ea823d60f2d47db1e0d72))
* **extension:** support for obtaining snapshot data ([aac9fe0](https://github.com/didi/ChartFlow/commit/aac9fe0fa62573ae43faa5f7473df3761f10d2cc))
* **extension:** turbo-adapter ([1b4c99e](https://github.com/didi/ChartFlow/commit/1b4c99e1a2d1f996e4e3b65d39d6b586f0f69937))
* **extension:** v0.2.0 ([ee67636](https://github.com/didi/ChartFlow/commit/ee676365b82d2d07d40cbc77e955eb3506690804))
* group ([2c75b81](https://github.com/didi/ChartFlow/commit/2c75b810d2bda185e37e029a5fe28503f299e412))
* increase width and height of snapshot data ([e223510](https://github.com/didi/ChartFlow/commit/e2235105899982a2a63c83d613c0268d111deecd))
* mini map position required ([907990e](https://github.com/didi/ChartFlow/commit/907990e5b1d10ee7b66ceac1a1104a4f46b00a6c))
* mvp demo ([12d5e96](https://github.com/didi/ChartFlow/commit/12d5e9684bad4a465e1b57a1217aceed73453d59))
* new plugin Selection & example ([2e4b489](https://github.com/didi/ChartFlow/commit/2e4b48958dff21617b6f7b08c9840deac0a178f0))
* register support config ([074c584](https://github.com/didi/ChartFlow/commit/074c58443df30b8d0a0beeee8deb1d0866f90f66))
* remove object attributes ([a242500](https://github.com/didi/ChartFlow/commit/a242500edf2e2e197cd0a015d2e490e474ff585e))
* resize node ([2bc595e](https://github.com/didi/ChartFlow/commit/2bc595eadea58e1597f730520b830efc41a0dac5))
* set anchors id ([17c4105](https://github.com/didi/ChartFlow/commit/17c4105474084b01c656298b30c28d0cd2908a36))
* support class as extension ([ac66e9f](https://github.com/didi/ChartFlow/commit/ac66e9ffd6709a605c48b61281be102429524b82))
* support ie11 ([46df695](https://github.com/didi/ChartFlow/commit/46df6951b1af5b1e46bea4ed084aa6abd5ebddf0))
* support keep path id ([65c42e6](https://github.com/didi/ChartFlow/commit/65c42e6820ee512d2527e999304d03a8a5c48713))
* 增加移动节点跳过校验规则功能 ([659b83e](https://github.com/didi/ChartFlow/commit/659b83eb8ab6c8f3a1f60333e11e24777795a14b))
* 替换文件夹名称 ([9155d8a](https://github.com/didi/ChartFlow/commit/9155d8a7af3cd0aff983f8a036bd3ffafd0d4d56))
* 自定义节点model支持获取graphModel ([4ae15aa](https://github.com/didi/ChartFlow/commit/4ae15aa243ae91184145be0df0cbb42baeb88de4))
* 解决bpmn element 导出model和view存在的问题 ([c6a259a](https://github.com/didi/ChartFlow/commit/c6a259af7af307795ab6b07d1a23c5208b6a89e4))
